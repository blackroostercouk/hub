                    ...
                    a(t, [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                var t = void 0,
                                    e = void 0;
                                this.height / this.width < this.imageAspect ? ((t = 1), (e = this.height / this.width / this.imageAspect)) : ((t = (this.width / this.height) * this.imageAspect), (e = 1)),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.program = this.gl.createProgram()),
                                    ...
                                    (this.uResolution = new h("resolution", "4f", this.program, this.gl)),
                                    (this.uMouse = new h("mouse", "2f", this.program, this.gl)),
                                    (this.uTime = new h("time", "1f", this.program, this.gl)),
                                    (this.uRatio = new h("pixelRatio", "1f", this.program, this.gl)),
                                    (this.uThreshold = new h("threshold", "2f", this.program, this.gl)),
        ...
        !(function (t) {
            ...
            if (void 0 === t.FULLTILT || null === t.FULLTILT) {
                var r = Math.PI,
                    ...
                    c = r / 180,
                    h = 180 / r,
                    u = { orientation: { active: !1, callbacks: [], data: void 0 }, motion: { active: !1, callbacks: [], data: void 0 } },
                        ...
                        getDeviceOrientation: function (t) {
                            return new Promise(function (e, a) {
                                ...
                                n.start(),
                                    new i(u.orientation)
                                        .then(function () {
                                            (n._alphaAvailable = u.orientation.data.alpha && null !== u.orientation.data.alpha),
                                                (n._betaAvailable = u.orientation.data.beta && null !== u.orientation.data.beta),
                                                (n._gammaAvailable = u.orientation.data.gamma && null !== u.orientation.data.gamma),
                                                e(n);
                                        })
                                        .catch(function () {
                        ...
                        getDeviceMotion: function (t) {
                            return new Promise(function (e, a) {
                                ...
                                n.start(),
                                    new i(u.motion)
                                        .then(function () {
                                            (n._accelerationXAvailable = u.motion.data.acceleration && u.motion.data.acceleration.x),
                                                (n._accelerationYAvailable = u.motion.data.acceleration && u.motion.data.acceleration.y),
                                                (n._accelerationZAvailable = u.motion.data.acceleration && u.motion.data.acceleration.z),
                                                (n._accelerationIncludingGravityXAvailable = u.motion.data.accelerationIncludingGravity && u.motion.data.accelerationIncludingGravity.x),
                                                (n._accelerationIncludingGravityYAvailable = u.motion.data.accelerationIncludingGravity && u.motion.data.accelerationIncludingGravity.y),
                                                (n._accelerationIncludingGravityZAvailable = u.motion.data.accelerationIncludingGravity && u.motion.data.accelerationIncludingGravity.z),
                                                (n._rotationRateAlphaAvailable = u.motion.data.rotationRate && u.motion.data.rotationRate.alpha),
                                                (n._rotationRateBetaAvailable = u.motion.data.rotationRate && u.motion.data.rotationRate.beta),
                                                (n._rotationRateGammaAvailable = u.motion.data.rotationRate && u.motion.data.rotationRate.gamma),
                                                e(n);
                                        })
                                        .catch(function () {
                                ...
                                (this.setFromEuler = (function () {
                                    ...
                                    return function (d) {
                                        return (
                                            ...
                                            (u = Math.sin(n)),
                                            (m = Math.sin(o)),
                                            this.set(h * s * l - r * u * m, r * u * l + h * s * m, r * s * m + h * u * l, r * s * l - h * u * m),
                                            this.normalize(),
                                            this
                                        );
                                    };
                ...
                (y.Quaternion.prototype = {
                            ...
                            (this.setFromEuler = (function () {
                                ...
                                return function (h) {
                                    return (
                                        ...
                                        (s = Math.sin(e)),
                                        (l = Math.sin(i)),
                                        this.set(o * n - l * r * s, -a * l, n * l * r + o * s, n * l + o * r * s, o * a, l * s - o * n * r, -a * s, r, a * n),
                                        this.normalize(),
                                        this
                                    );
                                };
                        ...
                        rotateByAxisAngle: (function () {
                            ...
                            return function (o, r, s) {
                                return (
                                    ...
                                    (e = Math.cos(s)),
                                    1 === r[0] && 0 === r[1] && 0 === r[2]
                                        ? ((n = !0), (a.elements[4] = e), (a.elements[5] = -t), (a.elements[7] = t), (a.elements[8] = e))
                                        : 1 === r[1] && 0 === r[0] && 0 === r[2]
                                        ? ((n = !0), (a.elements[0] = e), (a.elements[2] = t), (a.elements[6] = -t), (a.elements[8] = e))
                                        : 1 === r[2] && 0 === r[0] && 0 === r[1] && ((n = !0), (a.elements[0] = e), (a.elements[1] = -t), (a.elements[3] = t), (a.elements[4] = e)),
                                    n ? ((i = y.RotationMatrix.prototype.multiplyMatrices(o, a)), (i = y.RotationMatrix.prototype.normalize(i))) : (i = o),
                                    i
                                );
                            };
                        })(),
                    ...
                    (y.Euler = function (t, e, i) {
                        (this.set = function (t, e, i) {
                            ...
                            (this.setFromRotationMatrix = (function () {
                                ...
                                return function (n) {
                                    (t = n.elements)[8] > 0
                                        ? ((e = Math.atan2(-t[1], t[4])), (i = Math.asin(t[7])), (a = Math.atan2(-t[6], t[8])))
                                        : t[8] < 0
                                        ? ((e = Math.atan2(t[1], -t[4])), (i = -Math.asin(t[7])), (i += i >= 0 ? -r : r), (a = Math.atan2(t[6], -t[8])))
                                        : t[6] > 0
                                        ? ((e = Math.atan2(-t[1], t[4])), (i = Math.asin(t[7])), (a = -s))
                                        : t[6] < 0
                                        ? ((e = Math.atan2(t[1], -t[4])), (i = -Math.asin(t[7])), (i += i >= 0 ? -r : r), (a = -s))
                                        : ((e = Math.atan2(t[3], t[0])), (i = t[7] > 0 ? s : -s), (a = 0)),
                                        0 > e && (e += l),
                                        (e *= h),
                                        (i *= h),
                                        (a *= h),
                            ...
                            (this.setFromQuaternion = (function () {
                                ...
                                return function (a) {
                                    var n = a.w * a.w,
                                        ...
                                        m = n + o + c + u,
                                        d = a.w * a.x + a.y * a.z;
                                    if (d > 0.499999 * m) (t = 2 * Math.atan2(a.y, a.w)), (e = s), (i = 0);
                                    else if ((1e-6 - 0.5) * m > d) (t = -2 * Math.atan2(a.y, a.w)), (e = -s), (i = 0);
                                    else {
                                        var v = n - o + c - u,
                                            g = 2 * (a.w * a.z - a.x * a.y),
                                            f = n - o - c + u,
                    ...
                    (y.DeviceOrientation = function (e) {
                        ...
                        if (((this.alphaOffsetScreen = 0), (this.alphaOffsetDevice = void 0), "game" === this.options.type)) {
                            var n = function (e) {
                                return null !== e.alpha && ((this.alphaOffsetDevice = new y.Euler(e.alpha, 0, 0)), this.alphaOffsetDevice.rotateZ(-d), ++a >= 10)
                                    ? void t.removeEventListener("deviceorientation", n, !1)
                                    : void (++i >= 200 && t.removeEventListener("deviceorientation", n, !1));
                            }.bind(this);
                            ...
                            var o = function (e) {
                                return !0 !== e.absolute &&
                                    ...
                                    ((this.alphaOffsetDevice = new y.Euler(e.webkitCompassHeading, 0, 0)), this.alphaOffsetDevice.rotateZ(d), (this.alphaOffsetScreen = d), ++a >= 10)
                                    ? void t.removeEventListener("deviceorientation", o, !1)
                                    : void (++i >= 200 && t.removeEventListener("deviceorientation", o, !1));
                            }.bind(this);
                    ...
                    (y.DeviceOrientation.prototype = {
                        ...
                        start: function (e) {
                            e && "[object Function]" == Object.prototype.toString.call(e) && u.orientation.callbacks.push(e),
                                m ? t.screen.orientation.addEventListener("change", a, !1) : t.addEventListener("orientationchange", a, !1),
                                u.orientation.active || (t.addEventListener("deviceorientation", n, !1), (u.orientation.active = !0));
                        },
                        stop: function () {
                        ...
                        getFixedFrameQuaternion: (function () {
                            var t = new y.Euler(),
                                ...
                                i = new y.Quaternion();
                            return function () {
                                var a = u.orientation.data || { alpha: 0, beta: 0, gamma: 0 },
                                    n = a.alpha;
                                return (
                                    this.alphaOffsetDevice && (e.setFromEuler(this.alphaOffsetDevice), e.rotateZ(-this.alphaOffsetScreen), t.setFromRotationMatrix(e), t.alpha < 0 && (t.alpha += 360), (t.alpha %= 360), (n -= t.alpha)),
                        ...
                        getFixedFrameMatrix: (function () {
                            var t = new y.Euler(),
                                e = new y.RotationMatrix();
                            return function () {
                                var i = u.orientation.data || { alpha: 0, beta: 0, gamma: 0 },
                                    a = i.alpha;
                                return (
                                    this.alphaOffsetDevice && (e.setFromEuler(this.alphaOffsetDevice), e.rotateZ(-this.alphaOffsetScreen), t.setFromRotationMatrix(e), t.alpha < 0 && (t.alpha += 360), (t.alpha %= 360), (a -= t.alpha)),
                    ...
                    (y.DeviceMotion.prototype = {
                        ...
                        getScreenAdjustedAcceleration: function () {
                            var t = u.motion.data && u.motion.data.acceleration ? u.motion.data.acceleration : { x: 0, y: 0, z: 0 },
                                e = {};
                            switch (d) {
                                case v:
                                    (e.x = -t.y), (e.y = t.x);
                        ...
                        getScreenAdjustedAccelerationIncludingGravity: function () {
                            var t = u.motion.data && u.motion.data.accelerationIncludingGravity ? u.motion.data.accelerationIncludingGravity : { x: 0, y: 0, z: 0 },
                                e = {};
                            switch (d) {
                                case v:
                                    (e.x = -t.y), (e.y = t.x);
                        ...
                        getScreenAdjustedRotationRate: function () {
                            var t = u.motion.data && u.motion.data.rotationRate ? u.motion.data.rotationRate : { alpha: 0, beta: 0, gamma: 0 },
                                e = {};
                            switch (d) {
                                case v:
            ...
            (n = {
                GyroNorm: (function () {
                    ...
                    function e() {
                        ...
                        var s = {
                            do: { alpha: t(r), beta: t(e.beta), gamma: t(e.gamma), absolute: v.isAbsolute() },
                            dm: { x: t(i.x), y: t(i.y), z: t(i.z), gx: t(n.x), gy: t(n.y), gz: t(n.z), alpha: t(o.alpha), beta: t(o.beta), gamma: t(o.gamma) },
                        };
                    ...
                    return (
                        ...
                        (E.prototype.init = function (t) {
                            t && t.frequency && (f = t.frequency),
                                ...
                                t && "number" == typeof t.decimalCount && t.decimalCount >= 0 && (A = parseInt(t.decimalCount)),
                                t && t.logger && (x = t.logger),
                                t && t.screenAdjusted && (b = t.screenAdjusted);
                            var e = new FULLTILT.getDeviceOrientation({ type: y }).then(function (t) {
                                    v = t;
                                }),
                        ...
                        (E.prototype.start = function (t) {
                            return d
                                ? ((c = setInterval(function () {
                                  ...
                                  void (m = !0))
                                : void i({ message: 'GyroNorm is not initialized yet. First call the "init()" function.', code: 1 });
                        }),
